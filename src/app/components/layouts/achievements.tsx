...
const achievements = [
  {
    ...
    description: 'Won first place in college tech fest for IoT-based smart agriculture system',
    date: 'March 2025',
    icon: Trophy,
  ...
  },
  {
    ...
    description: 'Completed comprehensive full stack web development bootcamp',
    date: 'January 2025',
    icon: Award,
  ...
  },
  {
    ...
    description: 'First place in 24-hour hackathon for developing smart home automation',
    date: 'December 2024',
    icon: Star,
  ...
  },
  {
    ...
    description: 'Runner-up in national IoT innovation challenge with weather monitoring system',
    date: 'October 2024',
    icon: Target,
